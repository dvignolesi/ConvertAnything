...
void ConvertTools::tempMath(QList<double> *numbersToConvert, int whoSignaled)
{
    //Qlist/whoSignaled - 1. Fahrenheit 2. Celcius, 3. Kelvin 4. Rankine

    switch(whoSignaled) {
    case 1: //Farenheit to 1. Celcius 2. Kelvin 3. Rankine
        ...
        break;
    case 2: // Celcius to 1. Farenheit 2. Kelvin 3. Rankine
        ...
        break;
    case 3: // Kelvin to 1. Farenheit 2. Celcius 3. Rankine
        ...
        break;
    case 4: // Rankine to 1. Farenheit 2. Celcius 3. Kelvin
